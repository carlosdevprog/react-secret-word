...
function App() {
  ...
  const [guesses, setGuesses] = useState(guessesQty) // quantidade de chances
  const [score, setScore] = useState(0) // pontuação. Começa com zero. 
  ...
  const verifyLetter = (letter) => {
    ...
    //check if latter has already been utilized
